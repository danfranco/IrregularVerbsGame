...
//--- maxima puntuacion
int maxScore = espanol.size() * (3 - help);
...
Puntuación final <%=score %> de <%=maxScore %>.
</p>

<%
float greenPercent = ((score*100) / maxScore);
%>
...
<p class="small-text" style="margin-left: 40px;"><%=repaso %></p>
</p>
<% } %>
