...
<input class="big-text" type="text" name="answer1" autocomplete="off"
<% if (help > 0) { %>
	value="<%=ingles1.get(question) %>"
<% } %> 
/>
<input class="big-text" type="text" name="answer2" autocomplete="off"
<% if (help > 1) { %>
	value="<%=ingles2.get(question) %>"
<% } %> 
/>
<input class="big-text" type="text" name="answer3" autocomplete="off" />
